								...
								<table cellspacing="0" class="table table-small-font table-bordered table-striped">
									...
									@foreach ($list as $item)
										<tr>
											...
											<td>{!!($key=='id' || $key=='title')?"<a href=\"../show/{$table}/{$item['id']}\">$value</a>":$value!!}</td>
											@endforeach
											<td>
														<a href="/admin/model/config/list/wcms_access" class="btn btn-success btn-sm btn-icon icon-left">查看</a>
														<a href="/admin/model/config/form/wcms_access" class="btn btn-info btn-sm btn-icon icon-left">编辑</a>
