	<nav class="navbar horizontal-menu navbar-fixed-top"><!-- set fixed position by adding class "navbar-fixed-top" -->
		...
		<div class="navbar-inner">
			...
			<div class="navbar-brand">
				<a href="/" class="logo">
					<img src="{{$static_base}}/images/logo-white-bg@2x.png" width="80" alt="" class="hidden-xs" />
					<img src="{{$static_base}}/images/logo@2x.png" width="80" alt="" class="visible-xs" />
				</a>
			...
			<ul class="nav nav-userinfo navbar-right">
				...
				<li class="dropdown user-profile">
					<a href="#" data-toggle="dropdown">
						<img src="{{$static_base}}/images/user-1.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
						<span>
							Arlind Nushi
